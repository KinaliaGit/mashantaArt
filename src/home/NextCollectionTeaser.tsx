    ...
    <section className="border-y border-white/10 bg-ink py-20 text-bone sm:py-28">
      <div className="mx-auto grid max-w-[1440px] gap-10 px-5 sm:px-8 md:grid-cols-[1.1fr_1fr] md:items-center md:gap-16">
        <Reveal variant="rise">
          ...
          <p className="mt-7 font-mono text-[0.7rem] uppercase tracking-[0.3em] text-graphite-soft">Próximamente</p>
        </Reveal>

        <Reveal variant="wipe" delay={0.1} className="aspect-[4/5] w-full overflow-hidden border border-white/10 opacity-95 md:aspect-auto">
          <ArtVisual
